package com.zjf.config.validate;


import com.zjf.common.exception.BusinessException;
import com.zjf.common.exception.ResCodeEnum;
...
public class ParamsValidator implements SmartValidator {
    ...
    public void validate(Object target, Errors errors, Object... validationHints) {
        if (target == null) {
            throw new BusinessException(ResCodeEnum.PARAM_ERROR.getCode(), "参数不能为空！");
        } else {
    ...
    private void validate(Object target, Object... objs) {
        ...
        for (ConstraintViolation item : violations) {
            throw new BusinessException(ResCodeEnum.PARAM_ERROR.getCode(), item.getMessage());
        }
    }
}
